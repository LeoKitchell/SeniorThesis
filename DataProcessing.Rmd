...
save(tractDataNoText, file = "./Data/OtherData/TESTtractDataNoText.RData")
...
library(tm)
library(tidyverse)
lapply(c("processedFullCorpus.RData","tractDataNoText.RData"),load,envir=.GlobalEnv) #loads necessary data
```
...
sparsities <- c(.6,.7,.8)#c(.5,.6,.7,.8,.9,.95,.99)
...
ii<-1
while (ii < length(trainSparseList)+1) {
...
summary(rangerLargeModels[[3]]$finalModel$prediction.error)
```
...
save(list = c("rangerMediumModels","impPlotsMediumRanger","predictMediumRangers"),file = "./Data/OtherData/mediumRangerResults.RData")
...
save(list = c("rangerMediumModelsTFIDF","impPlotsMediumRangerTFIDF","predictMediumRangersTFIDF"),file = "./Data/OtherData/mediumRangerResultsTFIDF.RData")
...
save(list = c("rangerSmallModels","impPlotsSmallRanger","predictSmallRangers"),file = "./Data/OtherData/smallRangerResults.RData")
...
library(tidyverse)
list.files(path,'*.csv')
results <- c(list.files("./OtherData/","*RangerResults.RData"),list.files("./OtherData/","*RangerResultsTFIDF.RData"))

load(c("largeRangerResults.RData","largeRangerResultsTFIDF.RData","extraLargeRangerResults.RData"))
lapply(c("largeRangerResults.RData","largeRangerResultsTFIDF.RData","extraLargeRangerResults.RData"),load,envir=.GlobalEnv) #loads models
lapply(c("largeRangerResults.RData","largeRangerResultsTFIDF.RData","extraLargeRangerResults.RData"),load,envir=.GlobalEnv) #loads models
```
