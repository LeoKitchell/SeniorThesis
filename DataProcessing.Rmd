...
xxCrude <- data.frame(crude2.dtm.mat[,intersect(colnames(crude2.dtm.mat),
                                           colnames(crude1.dtm.mat))])
yyCrude <- read.table(textConnection(""), col.names = colnames(crude1.dtm.mat),
                 colClasses = "integer")
...
library(plyr)
zzCrude <- rbind.fill(xxCrude, yyCrude)
library(tidyverse)
```
...
impPlotsOptimalRanger
impPlotsOptimalRanger4 
plot(varImp(sparsityFiveOptimalRanger5),top = 50)
a <- (varImp(sparsityFiveOptimalRanger5))
```
