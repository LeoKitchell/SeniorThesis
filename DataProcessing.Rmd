...
```{r}
predictorData <- subset(combinedData,select = c(tractFIPS,gentrificationChange,totalPop.2014,popGrowth,review_scores_rating,
                                                review_scores_location,bedrooms,bathrooms,listing_price))
