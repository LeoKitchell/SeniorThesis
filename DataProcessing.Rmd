...
# To Do (Not in order):
 ...
 2) Aggregate to the tract level. 
          ...
          and use summarize to get the summary statistics like average and n() for the other variables
 3) run model with all variables so i cans ee the relative importance
 4) add a list of city names as stopwords. Also state names. 
