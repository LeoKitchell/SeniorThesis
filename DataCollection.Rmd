...
setwd(path)
list.files(path)
losAngeles <- read.csv(paste(path,"reviews_LosAngeles.csv",sep = ""))

n = nrow(losAngeles)
n=47
getwd()
write.csv(losAngeles[1:((n-1)/4),],"reviews_LosAngelesPt1.csv",row.names = FALSE)
write.csv(losAngeles[((n-1)/4):((n-1)/2),],"reviews_LosAngelesPt2.csv",row.names = FALSE)
write.csv(losAngeles[((n-1)/2+1):((n-1)*3/4),], "reviews_LosAngelesPt3.csv", row.names = FALSE)
write.csv(losAngeles[((n-1)*3/4):n,], "reviews_LosAngelesPt4.csv", row.names = FALSE)
```
