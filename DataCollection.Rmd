...
msaMappingData <- subset(censusDataWithDistributionsWideGeoms, select = c("GEOID","NAME.2014","CBSA.Title.x.2014","CBSA.Code.x.2014"))
...
hist(gentrifiableCensusDataWithDistributionsWide$gentrificationIndex.2014,breaks = 20, color)
hist(gentrifiableCensusDataWithDistributionsWide$gentrificationIndex.2019,breaks = 20)
hist(gentrifiableCensusDataWithDistributionsWide$gentrificationChange,breaks = 20)

summary(gentrifiableCensusDataWithDistributionsWide$gentrificationIndex.2014)
summary(gentrifiableCensusDataWithDistributionsWide$gentrificationIndex.2019)
```
